  ...
  <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24">
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
        <div className="flex justify-center text-teal-600 sm:justify-start">
         The Eldoret Achievers School
        </div>

        <p className="mt-6 max-w-md text-center leading-relaxed text-gray-500 sm:max-w-xs sm:text-left">
        where education shines bright and empowers students to reach their full potential. Our website is designed to provide you with a comprehensive overview of our school's offerings, values, and community
        </p>
    ...
    <div className="mt-12 border-t border-gray-100 pt-6">
      <div className="text-center sm:flex sm:justify-between sm:text-left">
        ...
        <p className="mt-4 text-sm text-gray-500 sm:order-first sm:mt-0">&copy; 2024 The Eldoret Achievers. Made by <span><a href='https://sultan.theotherguyske.org' target='_blank' className='  underline'>Mitch</a></span></p>
      </div>
    </div>
  </div>
</footer>
